...
{
   //The native Android pixel type is RGB565,                !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
//  esRegisterDrawFunc()
//
void ESUTIL_API esRegisterDrawFunc ( ESContext *esContext, /*void (ESCALLBACK *drawFunc) (ESContext* )*/ drawFunc_T drawFunc )
{
...
//
void ESUTIL_API esRegisterUpdateFunc ( ESContext *esContext, /*void (ESCALLBACK *updateFunc) ( ESContext*, float )*/updateFunc_T updateFunc )
{
...
void ESUTIL_API esRegisterKeyFunc ( ESContext *esContext,
                                    /*void (ESCALLBACK *keyFunc) (ESContext*, unsigned char, int, int )*/keyFunc_T keyFunc )
{
