...
public abstract class AbstractPrologCommandPlayer implements CommandPlayer {
	...
	protected AbstractPrologCommandPlayer(Context ctx, FCNavSettings settings, String voiceProvider, String configFile, int[] sortedVoiceVersions)
	...
	private void init(String voiceProvider, FCNavSettings settings, String configFile) throws CommandPlayerException {
		prologSystem.clearTheory();
		voiceDir = null;
		if (voiceProvider != null) {
			File parent = ((FCNavApplication)ctx.getApplicationContext()).getSettings().extendFlcnavPath(ResourceManager.VOICE_PATH);
