...
public class TTSCommandPlayerImpl extends AbstractPrologCommandPlayer {
	...
	protected TTSCommandPlayerImpl(Activity ctx, FCNavSettings settings, String voiceProvider)
		...
		FCNavApplication app = (FCNavApplication) ctx.getApplicationContext();
