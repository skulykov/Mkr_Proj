...
import net.fcnav.plus.voice.AbstractPrologCommandPlayer;
import net.fcnav.plus.voice.CommandBuilder;
...
public class VoiceRouter {
	...
	public void updateAppMode(){
		...
		if(router.getAppMode() == ApplicationMode.TRUCK){
			// prepare distance is not needed for TRUCK
