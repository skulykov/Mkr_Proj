...
import net.flcnav.plus.render.RenderingIcons;
...
public class POIMapLayer extends FCNavMapLayer implements ContextMenuLayer.IContextMenuProvider {
	...
	private StringBuilder buildPoiInformation(StringBuilder res, Amenity n) {
		String format = FCNavFormatter.getPoiSimpleFormat(n, view.getContext(), view.getSettings().USE_ENGLISH_NAMES.get());
		res.append(" " + format);
	...
	private void showDescriptionDialog(Amenity a) {
		...
		bs.setTitle(FCNavFormatter.getPoiSimpleFormat(a, view.getContext(), view.getSettings().USE_ENGLISH_NAMES.get()));
