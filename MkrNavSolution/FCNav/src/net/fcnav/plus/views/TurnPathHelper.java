...
public class TurnPathHelper {
	...
	public static class RouteDrawable extends Drawable {
		...
		public void setRouteType(TurnType t){
			...
			//onBoundsChange(getBounds());   //svk the icon size = zero here !!!!!!!!!!!!!!!!!!
			                                 // zero bouds result in wrong transform (p.transform(m, dp);)
		}
...
//			canvas.drawPath(dp, paintRouteDirection);
			...
			Path cc=new Path();
			cc.addCircle(20, 20, 10, Direction.CW);
		    canvas.drawPath(cc, cp);
			*/
		}
