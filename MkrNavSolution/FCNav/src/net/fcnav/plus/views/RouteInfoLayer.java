...
import net.fcnav.plus.routing.RoutingHelper.IRouteInformationListener;
...
public class RouteInfoLayer extends FCNavMapLayer implements IRouteInformationListener {
	...
	public boolean isVisible(){
		return visible && routingHelper.isRouteCalculated();// svk  && !routingHelper.isFollowingMode();
	}
	public boolean couldBeVisible(){
		return routingHelper.isRouteCalculated(); //svk && !routingHelper.isFollowingMode();
	}
