...
public class ContextMenuLayer extends FCNavMapLayer {
...
//	private ImageView closeButton;   // svk removed Close Button
...
//		textView.setMaxLines(15);
	...
	public boolean onLongPressEvent(PointF point) {
		...
		selectedObjects.clear();
		for(FCNavMapLayer l : view.getLayers()){
		...
		if(selectedObjects.size() > 1){
			...
			builder.setItems(d, new OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					for(FCNavMapLayer layer : view.getLayers()) {
