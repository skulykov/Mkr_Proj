...
public class NextTurnInfoControl extends MapInfoControl {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (!horisontalMini) {
			...
			w = (int) textPaint.measureText(FCNavFormatter.getFormattedDistance(nextTurnDirection, getContext()));
		}
	...
	protected void onDraw(Canvas canvas) {
		...
		if (pathForTurn != null) {
			...
			String text = FCNavFormatter.getFormattedDistance(nextTurnDirection, getContext());
			String subtext = null;

			if (makeUturnWhenPossible == true) {
				text = "make uturn asap";//getResources().getString(R.string.asap);
			}
