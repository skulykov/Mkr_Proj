...
import net.fcnav.plus.activities.FavouritesListActivity;
import net.fcnav.plus.activities.NavigatePointActivity;
...
public class SearchActivity extends TabActivity {
	...
	public static final String SEARCH_LAT = "net.flcnav.search_lat"; //$NON-NLS-1$
	public static final String SEARCH_LON = "net.flcnav.search_lon"; //$NON-NLS-1$
	...
	private static boolean searchOnLine = true; //svk false;
	...
	//svk
	public interface SearchActivityNotify {
		
		public void notifyOnSearch(final int flag, final List<Place> places);
	}
	...
	public void startSearchAddressOffline(){
		//svk Only OnLineActivity screen
