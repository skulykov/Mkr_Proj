...
public class SavingTrackHelper extends SQLiteOpenHelper {
	...
	public SavingTrackHelper(FCNavApplication ctx){
	...
	public List<String> saveDataToGpx() {
		...
		File dir = ((FCNavApplication) ctx.getApplicationContext()).getSettings().getExternalStorageDirectory();
		if (dir.canWrite()) {
...
//			db.execSQL("DELETE FROM " + POINT_NAME + " WHERE 1 = 1", new Object[] { }); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void insertData(double lat, double lon, double alt, double speed, double hdop, long time, FCNavSettings settings){
