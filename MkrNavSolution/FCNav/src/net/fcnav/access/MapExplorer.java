...
import net.fcnav.plus.views.FCNavMapLayer;
import net.fcnav.plus.views.FCNavMapTileView;
import net.fcnav.plus.views.ContextMenuLayer.IContextMenuProvider;
...
public class MapExplorer implements OnGestureListener, IContextMenuProvider {
    ...
    // is enabled.
    public MapExplorer(FCNavMapTileView mapView, OnGestureListener fallback) {
    ...
    private void describePointedObjects(MotionEvent event) {
        ...
        for (FCNavMapLayer layer : mapView.getLayers())
