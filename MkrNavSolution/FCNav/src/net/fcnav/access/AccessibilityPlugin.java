...
public class AccessibilityPlugin extends FCNavPlugin {
	private static final String ID = "flcnav.accessibility";
	...
	public AccessibilityPlugin(FCNavApplication app) {
		this.app = app;
	}
	...
	public String getDescription() {
		return app.getString(R.string.flcnav_accessibility_description);
	}
	@Override
