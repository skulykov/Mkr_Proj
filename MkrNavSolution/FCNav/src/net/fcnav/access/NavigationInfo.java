...
public class NavigationInfo {
    ...
    public NavigationInfo(final Context context) {
        ...
        settings = ((FCNavApplication) context.getApplicationContext()).getSettings();
    ...
    private String distanceString(final Location point) {
        return FCNavFormatter.getFormattedDistance(currentLocation.distanceTo(point), context);
    }
    ...
    public synchronized String getSpeedString() {
        if ((currentLocation != null) && currentLocation.hasSpeed()) {
            String result = FCNavFormatter.getFormattedSpeed(currentLocation.getSpeed(), context);
            if (currentLocation.hasBearing())
    ...
    public synchronized String getAccuracyString() {
        ...
        if (currentLocation != null) {
            ...
            if (currentLocation.hasAccuracy())
                result = getString(R.string.accuracy) + " " + FCNavFormatter.getFormattedDistance(currentLocation.getAccuracy(), context); //$NON-NLS-1$
            if (result != null)
    ...
    public synchronized String getAltitudeString() {
        if ((currentLocation != null) && currentLocation.hasAltitude())
            return getString(R.string.altitude) + " " + FCNavFormatter.getFormattedDistance((float)currentLocation.getAltitude(), context); //$NON-NLS-1$
        return null;
    }
    ...
    public synchronized void setLocation(Location location) {
        ...
        if (autoAnnounce && ((FCNavApplication)(context.getApplicationContext())).accessibilityEnabled()) {
