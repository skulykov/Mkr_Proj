...
import net.flcnav.plus.render.TextRenderer.TextDrawInfo;
...
public class FlcnavRenderer {
	private static final Log log = LogUtil.getLog(FlcnavRenderer.class);
	...
	/* package */static class RenderingContext extends net.flcnav.RenderingContext {
	...
	public FlcnavRenderer(Context context) {
	 ...
	 */
	public void generateNewBitmapNative(RenderingContext rc, NativeFlcnavLibrary library, 
