...
public class RecognizerTask implements Runnable {
	...
	public RecognizerTask() {
		pocketsphinx
				.setLogfile("/mnt/sdcard/fcnav/SpeechRecog/pocketsphinx.log");
		Config c = new Config();
		/*
		 * In 2.2 and above we can use getExternalFilesDir() or whatever it's
		 * called
		 */
		c.setString("-hmm",	"/mnt/sdcard/fcnav/SpeechRecog/hmm/en_US/hub4wsj_sc_8k");
		//c.setString("-dict","/mnt/sdcard/fcnav/SpeechRecog/lm/en_US/hub4.5000.dic");
		//c.setString("-lm","/mnt/sdcard/fcnav/SpeechRecog/lm/en_US/hub4.5000.DMP");
		c.setString("-dict","/mnt/sdcard/fcnav/SpeechRecog/lm/en_US/4744.dic");
		c.setString("-lm","/mnt/sdcard/fcnav/SpeechRecog/lm/en_US/4744.lm");
		
		
		/*
		c.setString("-hmm",
		"/mnt/sdcard/fcnav/SpeechRecog/hmm/zh/tdt_sc_8k");
		c.setString("-dict",
		"/mnt/sdcard/fcnav/SpeechRecog/lm/zh_TW/mandarin_notone.dic");
		c.setString("-lm",
		"/mnt/sdcard/fcnav/SpeechRecog/lm/zh_TW/gigatdt.5000.DMP");
		*/
		c.setString("-rawlogdir", "/mnt/sdcard/fcnav/SpeechRecog");
