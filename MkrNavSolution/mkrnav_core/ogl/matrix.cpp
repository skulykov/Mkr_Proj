...
– Inner loop requires n multiplications and n 􀀀 1 additions
– Complexity of inner loop is (n)
– There are a total of m dot products
– Overall complexity: (mn); (n2) for a square matrix
