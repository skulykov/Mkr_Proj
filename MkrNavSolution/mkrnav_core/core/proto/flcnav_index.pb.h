...
// source: flcnav_index.proto

#ifndef PROTOBUF_flcnav_5findex_2eproto__INCLUDED
#define PROTOBUF_flcnav_5findex_2eproto__INCLUDED
...
void protobuf_AssignDesc_flcnav_5findex_2eproto();
void protobuf_ShutdownFile_flcnav_5findex_2eproto();

class FlcNavStoredIndex;
class FileIndex;
class AddressPart;
class CityBlock;
class PoiPart;
...
class FlcNavStoredIndex : public ::google::protobuf::MessageLite {
 public:
  FlcNavStoredIndex();
  virtual ~FlcNavStoredIndex();
  
  FlcNavStoredIndex(const FlcNavStoredIndex& from);
  
  inline FlcNavStoredIndex& operator=(const FlcNavStoredIndex& from) {
    CopyFrom(from);
    return *this;
  }
  
  static const FlcNavStoredIndex& default_instance();
  
  void Swap(FlcNavStoredIndex* other);
  
  // implements Message ----------------------------------------------
  
  FlcNavStoredIndex* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
  void CopyFrom(const FlcNavStoredIndex& from);
  void MergeFrom(const FlcNavStoredIndex& from);
  void Clear();
  ...
  // @@protoc_insertion_point(class_scope:FlcNavStoredIndex)
 private:
  ...
  friend void  protobuf_AddDesc_flcnav_5findex_2eproto();
  friend void protobuf_AssignDesc_flcnav_5findex_2eproto();
  friend void protobuf_ShutdownFile_flcnav_5findex_2eproto();
  ...
  static FlcNavStoredIndex* default_instance_;
};
// -------------------------------------------------------------------
...
// required uint32 version = 1;
inline bool FlcNavStoredIndex::has_version() const {
  return _has_bit(0);
}
inline void FlcNavStoredIndex::clear_version() {
  version_ = 0u;
  _clear_bit(0);
}
inline ::google::protobuf::uint32 FlcNavStoredIndex::version() const {
  return version_;
}
inline void FlcNavStoredIndex::set_version(::google::protobuf::uint32 value) {
  _set_bit(0);
  version_ = value;
}

// required int64 dateCreated = 18;
inline bool FlcNavStoredIndex::has_datecreated() const {
  return _has_bit(1);
}
inline void FlcNavStoredIndex::clear_datecreated() {
  datecreated_ = GOOGLE_LONGLONG(0);
  _clear_bit(1);
}
inline ::google::protobuf::int64 FlcNavStoredIndex::datecreated() const {
  return datecreated_;
}
inline void FlcNavStoredIndex::set_datecreated(::google::protobuf::int64 value) {
  _set_bit(1);
  datecreated_ = value;
}

// repeated .FileIndex fileIndex = 7;
inline int FlcNavStoredIndex::fileindex_size() const {
  return fileindex_.size();
}
inline void FlcNavStoredIndex::clear_fileindex() {
  fileindex_.Clear();
}
inline const ::FileIndex& FlcNavStoredIndex::fileindex(int index) const {
  return fileindex_.Get(index);
}
inline ::FileIndex* FlcNavStoredIndex::mutable_fileindex(int index) {
  return fileindex_.Mutable(index);
}
inline ::FileIndex* FlcNavStoredIndex::add_fileindex() {
  return fileindex_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::FileIndex >&
FlcNavStoredIndex::fileindex() const {
  return fileindex_;
}
inline ::google::protobuf::RepeatedPtrField< ::FileIndex >*
FlcNavStoredIndex::mutable_fileindex() {
  return &fileindex_;
}
...
#endif  // PROTOBUF_flcnav_5findex_2eproto__INCLUDED
