...
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_CHANGESET;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_ID;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_K;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_LAT;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_LON;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_REF;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_ROLE;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_TIMESTAMP;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_TYPE;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_UID;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_USER;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_V;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_VERSION;
import static net.flcnav.osm.io.OsmBaseStorage.ATTR_VISIBLE;
import static net.flcnav.osm.io.OsmBaseStorage.ELEM_MEMBER;
import static net.flcnav.osm.io.OsmBaseStorage.ELEM_ND;
import static net.flcnav.osm.io.OsmBaseStorage.ELEM_NODE;
import static net.flcnav.osm.io.OsmBaseStorage.ELEM_OSM;
import static net.flcnav.osm.io.OsmBaseStorage.ELEM_RELATION;
import static net.flcnav.osm.io.OsmBaseStorage.ELEM_TAG;
import static net.flcnav.osm.io.OsmBaseStorage.ELEM_WAY;
...
import net.flcnav.osm.EntityInfo;
