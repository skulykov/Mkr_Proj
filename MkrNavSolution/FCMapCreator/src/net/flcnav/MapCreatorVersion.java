...
public class MapCreatorVersion {
	...
	public static String APP_VERSION = "0.7.3"; //$NON-NLS-1$
	public static final String APP_DESCRIPTION = "alpha"; //$NON-NLS-1$

	public static final String APP_MAP_CREATOR_NAME = "FlcNavMapCreator"; //$NON-NLS-1$
	...
	public static String getVersionAsURLParam() {
		try {
			return "flcnavver=" + URLEncoder.encode(APP_VERSION + " " + APP_DESCRIPTION, "UTF-8");
