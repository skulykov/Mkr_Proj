...
public class BinaryMapRouteReaderAdapter {
	...
	protected void readRouteIndex(RouteRegion region) throws IOException {
		...
		while(true){
			...
			case 0:
				return;
			case FlcnavOdb.FlcNavRoutingIndex.NAME_FIELD_NUMBER :
				region.name = codedIS.readString();
				break;
			case FlcnavOdb.FlcNavRoutingIndex.RULES_FIELD_NUMBER: {
			...
			case FlcnavOdb.FlcNavRoutingIndex.ROOTBOXES_FIELD_NUMBER : {
