...
import net.flcnav.data.Building.BuildingInterpolation;
...
public class BinaryMapAddressReaderAdapter {
	...
	protected void readAddressIndex(AddressRegion region) throws IOException {
		while(true){
			...
			case 0:
				...
				return;
			case FlcnavOdb.FlcNavAddressIndex.NAME_FIELD_NUMBER :
				region.name = codedIS.readString();
				break;
			case FlcnavOdb.FlcNavAddressIndex.NAME_EN_FIELD_NUMBER :
				region.enName = codedIS.readString();
				break;
			case FlcnavOdb.FlcNavAddressIndex.CITIES_FIELD_NUMBER :
				...
				break;
			case FlcnavOdb.FlcNavAddressIndex.NAMEINDEX_FIELD_NUMBER :
	...
	protected void readCityStreets(SearchRequest<Street> resultMatcher, City city) throws IOException{
		...
		while(true){
			...
			case 0:
				return;
			case FlcnavOdb.CityBlockIndex.STREETS_FIELD_NUMBER :
				...
				codedIS.popLimit(oldLimit);
				break;
			case FlcnavOdb.CityBlockIndex.BUILDINGS_FIELD_NUMBER :
	...
	protected City readCityHeader(StringMatcher nameMatcher, int filePointer, boolean useEn) throws IOException{
		...
		while(true){
			...
			case 0:
				return c;
			case FlcnavOdb.CityIndex.CITY_TYPE_FIELD_NUMBER :
				int type = codedIS.readUInt32();
				c = new City(CityType.values()[type]);
				break;
			case FlcnavOdb.CityIndex.ID_FIELD_NUMBER :
				...
				break;
			case FlcnavOdb.CityIndex.NAME_EN_FIELD_NUMBER :
				...
				c.setEnName(enName);
				break;
			case FlcnavOdb.CityIndex.NAME_FIELD_NUMBER :
				...
				c.setName(name);
				break;
			case FlcnavOdb.CityIndex.X_FIELD_NUMBER :
				x = codedIS.readUInt32();
				break;
			case FlcnavOdb.CityIndex.Y_FIELD_NUMBER :
				...
				break;
			case FlcnavOdb.CityIndex.SHIFTTOCITYBLOCKINDEX_FIELD_NUMBER :
				int offset = readInt();
				offset += filePointer;
	...
	protected Street readStreet(Street s, SearchRequest<Building> buildingsMatcher, boolean loadBuildingsAndIntersected, int city24X, int city24Y, String postcodeFilter) throws IOException{
		...
		while(true){
			...
			case 0:
				...
				return s;
			case FlcnavOdb.StreetIndex.ID_FIELD_NUMBER :
				s.setId(codedIS.readUInt64());
				break;
			case FlcnavOdb.StreetIndex.NAME_EN_FIELD_NUMBER :
				s.setEnName(codedIS.readString());
				break;
			case FlcnavOdb.StreetIndex.NAME_FIELD_NUMBER :
				s.setName(codedIS.readString());
				break;
			case FlcnavOdb.StreetIndex.X_FIELD_NUMBER :
				...
				break;
			case FlcnavOdb.StreetIndex.Y_FIELD_NUMBER :
				...
				break;
			case FlcnavOdb.StreetIndex.INTERSECTIONS_FIELD_NUMBER :
				int length = codedIS.readRawVarint32();
				...
				break;
			case FlcnavOdb.StreetIndex.BUILDINGS_FIELD_NUMBER :
	...
	protected Street readIntersectedStreet(City c, int street24X, int street24Y) throws IOException{
		...
		while(true){
			...
			case 0:
				...
				return s;
			case FlcnavOdb.BuildingIndex.ID_FIELD_NUMBER :
				s.setId(codedIS.readUInt64());
				break;
			case FlcnavOdb.StreetIntersection.NAME_EN_FIELD_NUMBER:
				s.setEnName(codedIS.readString());
				break;
			case FlcnavOdb.StreetIntersection.NAME_FIELD_NUMBER:
				s.setName(codedIS.readString());
				break;
			case FlcnavOdb.StreetIntersection.INTERSECTEDX_FIELD_NUMBER :
				x =  codedIS.readSInt32() + street24X;
				break;
			case FlcnavOdb.StreetIntersection.INTERSECTEDY_FIELD_NUMBER :
	...
	protected Building readBuilding(int fileOffset, int street24X, int street24Y) throws IOException{
		...
		while(true){
			...
			case FlcnavOdb.BuildingIndex.ID_FIELD_NUMBER :
				...
				break;
			case FlcnavOdb.BuildingIndex.NAME_EN_FIELD_NUMBER :
				b.setEnName(codedIS.readString());
				break;
			case FlcnavOdb.BuildingIndex.NAME_FIELD_NUMBER :
				b.setName(codedIS.readString());
				break;
			case FlcnavOdb.BuildingIndex.NAME_EN2_FIELD_NUMBER :
				// no where to set now
				codedIS.readString();
				break;
			case FlcnavOdb.BuildingIndex.NAME2_FIELD_NUMBER :
				b.setName2(codedIS.readString());
				break;
			case FlcnavOdb.BuildingIndex.INTERPOLATION_FIELD_NUMBER :
				...
				break;
			case FlcnavOdb.BuildingIndex.X_FIELD_NUMBER :
				x =  codedIS.readSInt32() + street24X;
				break;
			case FlcnavOdb.BuildingIndex.Y_FIELD_NUMBER :
				y =  codedIS.readSInt32() + street24Y;
				break;
			case FlcnavOdb.BuildingIndex.POSTCODE_FIELD_NUMBER :
	...
	public void searchAddressDataByName(AddressRegion reg, SearchRequest<MapObject> req, int[] typeFilter) throws IOException {
		...
		while (true) {
			...
			case 0:
				return;
			case FlcNavAddressNameIndexData.TABLE_FIELD_NUMBER:
				int length = readInt();
				...
				codedIS.popLimit(oldLimit);
				break;
			case FlcNavAddressNameIndexData.ATOM_FIELD_NUMBER:
