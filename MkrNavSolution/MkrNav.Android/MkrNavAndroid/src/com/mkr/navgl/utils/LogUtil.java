 ...
 * 		Logger.getLogger("net.flcnav").setLevel(Level.ALL);
...
public class LogUtil {
	public static String TAG = "net.fcnavgl"; //$NON-NLS-1$
	private static class FlcnavLogImplementation implements Log {
		
		private final String fullName;
		private final String name;

		public FlcnavLogImplementation(String name){
			this.fullName = name;
...
//			return android.util.Log.isLoggable(TAG, android.util.Log.DEBUG);
	...
	public static Log getLog(String name){
		return new FlcnavLogImplementation(name);
	}
