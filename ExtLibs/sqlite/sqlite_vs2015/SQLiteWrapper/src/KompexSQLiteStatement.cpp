...
//svk addition
void SQLiteStatement::StartTransactionCmd()
{
	sqlite3_exec(mDatabase->GetDatabaseHandle(), "BEGIN TRANSACTION", NULL, NULL, NULL);
}
void SQLiteStatement::EndTransactionCmd()
{
	sqlite3_exec(mDatabase->GetDatabaseHandle(), "END TRANSACTION", NULL, NULL,NULL);
}
