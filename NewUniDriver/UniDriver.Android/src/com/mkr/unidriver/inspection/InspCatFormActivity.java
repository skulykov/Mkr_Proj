...
public class InspCatFormActivity extends OnResultBaseActivity{
	...
	@Override
	 public void onCreate(Bundle bundle) {
			...
			TextView vtv = (TextView)findViewById(R.id.insp_vid_id);
			vtv.setText("Vid:"+GConst.BoxID);
	        if(is_new==1)
	        {
	        	//new inspection form
//	        	GConst.g_IR_Builder = PInspectionRow.newBuilder();
	        	ttl=ttl+"Form";
	        	 ...
	        	 itv.setText( GConst.CurrentDriverName);
					itv1.setText(DateUtil.getTS(null));
					insp_form_tb_ll.setVisibility(View.VISIBLE);
	        }else{
	        	ir=GConst.g_IR;
	        	ttl=ttl+"Report";
	        	itv.setText( GConst.g_IR.getDrName());
				itv1.setText( DateUtil.getTS(GConst.g_IR.getInsTime()) );
