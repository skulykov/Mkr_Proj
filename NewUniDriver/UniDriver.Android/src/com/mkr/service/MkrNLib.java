...
public final class MkrNLib 
{
     ...
     */
     ...
     public PBoxIdVehicleRowList GetVehicles() {
    	 byte[] b= getVehicles();
		 if(b!=null)
		 {
			 PBoxIdVehicleRowList rv=null;
			 try {
				rv=PBoxIdVehicleRowList.parseFrom(b);
			} catch (InvalidProtocolBufferException e) {WriteExc2Log(e);}
			 return rv;
		 }
		 return null;
	...
	public native byte[] getVehicles();
	public native int saveVehicle(byte[] ba) ;
