...
public final class MkrNVMng 
{
    ...
    static public MkrNVMng Start()
    {
        ...
        mNativeManager = new MkrNVMng();
	   
        AssetManager assetMgr = MkrAppService.getAppContext().getAssets();
     ...
     * 
     */
    public void PostNativeMessage( int aMsgId, IMkrMessageParam aObjParam )
    {
        Message msg = Message.obtain( mUIMsgDispatcher, 
                            MkRlUIEvent.ToInt(MkRlUIEvent.UI_EVENT_NATIVE), aMsgId, 0 );
        msg.obj = aObjParam;
     ...
     * 
     */
    public void PostPriorityNativeMessage( int aMsgId, IMkrMessageParam aObjParam )
    {
        Message msg = Message.obtain( mUIMsgDispatcher, 
...
//                    + String.valueOf(this.getId()));
        ...
        public void handleMessage( Message aMsg )
        {
            ...
            switch (lEvent)
            {
                ...
                case UI_EVENT_NATIVE:
                {
                    ...
                    IMkrMessageParam prm = (IMkrMessageParam) aMsg.obj;
                    if ( prm != null )
                    {
                ...
                if (msg != null) {
                	...
                	switch (lEvent)
                	{
                		case UI_PRIORITY_EVENT_NATIVE:
                		{
                			...
                			// 2. If the object parameter is passed - check if the object is active
                			boolean isActive = true;
                			IMkrMessageParam prm = (IMkrMessageParam) msg.obj;
                			if ( prm != null )
                			{
                				isActive = prm.IsActive();
                				eventName = "Timer Event";
	...
	public void InitNativeManager()
    {
        ...
        mTimer = new Timer("MkrTimer");
        final int sdkBuildVersion = Integer.parseInt( android.os.Build.VERSION.SDK );
    	// Initialize the library
    	InitNativeMng("", 1, android.os.Build.DEVICE,android.os.Build.MODEL,"" );
        // Message box engine
	...
	//=================================================================
	 /*================================= Native methods section ================================= 
		     ...
		     */
	 native void InitNativeMng( String aLibPath, int aBuildSdkVersion, String aDeviceName,
	    		String aDeviceModel, String aDeviceManufacturer );
	 static native void createAssetManager(AssetManager assetMgr);
	...
	private static MkrNVMng mNativeManager         = null;
