...
bool IsTableExist(Kompex::SQLiteStatement *pStmt, std::string tableName)
{
	
	pStmt->Sql("select * from sqlite_master where type='table' and name=@tblName ");
