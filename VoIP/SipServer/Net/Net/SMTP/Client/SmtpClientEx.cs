...
using MkrSoft.Net;
using MkrSoft.Net.Dns.Client;
using MkrSoft.Net.Mime;

namespace MkrSoft.Net.SMTP.Client
{
	/// <summary>
...
/*		/// <summary>
		...
		public static void QuickSendSmartHost(string smartHost,int port,string hostName,MkrSoft.Net.Mime.Mime message)
		{
		...
		/// <param name="message">Mime message to send.</param>
		public static void QuickSendSmartHost(string smartHost,int port,string hostName,string userName,string password,MkrSoft.Net.Mime.Mime message)
		{
		...
		/// <param name="password">SMTP password.</param>
		/// <param name="message">Mime message to send.</param>
		public static void QuickSendSmartHost(string smartHost,int port,bool ssl,string hostName,string userName,string password,MkrSoft.Net.Mime.Mime message)
		{
			string from = "";
