...
namespace MkrSoft.Net.IMAP.Server
{
	...
	{				
		...
		/// <returns></returns>
		public static MimeEntity GetMimeEntity(MkrSoft.Net.Mime.Mime parser,string mimeEntitySpecifier)
		{
		...
		public static byte[] GetMimeEntityHeader(MkrSoft.Net.Mime.Mime parser,string mimeEntitySpecifier)
		{
		...
		/// For example: 1,1.1,2.1, ... .</param>
		/// <returns>Returns requested mime entity data or NULL if requested entry doesn't exist.</returns>
		public static byte[] GetMimeEntityData(MkrSoft.Net.Mime.Mime parser,string mimeEntitySpecifier)
		{
