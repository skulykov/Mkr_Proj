...
namespace MkrSoft.Net.IMAP.Server
{
	...
	internal class SearchGroup
	{
		...
		/// <returns></returns>
		internal static bool Match_Key_Value(object searchKey,long no,long uid,long size,DateTime internalDate,IMAP_MessageFlags flags,MkrSoft.Net.Mime.Mime mime,string bodyText)
		{
		...
		/// <param name="bodyText">Message body text.</param>
		/// <returns></returns>
		public bool Match(long no,long uid,long size,DateTime internalDate,IMAP_MessageFlags flags,MkrSoft.Net.Mime.Mime mime,string bodyText)
		{
