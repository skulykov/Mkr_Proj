...
using MkrSoft.Net.IMAP.Server;

namespace MkrSoft.Net.IMAP.Client
{
	/// <summary>
	/// IMAP fetch item.
	/// </summary>
		...
		public byte[] HeaderData
		{
			get{
				...
				if((m_FetchFlags & IMAP_FetchItem_Flags.Message) != 0){
					return System.Text.Encoding.ASCII.GetBytes(MkrSoft.Net.Mime.MimeUtils.ParseHeaders(new MemoryStream(m_Data)));
				}
				else{
					return m_Data;
				}
